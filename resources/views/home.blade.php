      ...
      <div class="row bg-white has-shadow">
        ...
        <div class="col-xl-4 col-sm-6">
          <div class="item d-flex align-items-center">
            ...
            <div class="title"><span>Totall<br>Links</span>
              <div class="progress">
                <div role="progressbar" style="width: 25%; height: 4px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
              </div>
            </div>
            <div class="number"><strong class="text-right">{{ $linkCOunt }}</strong></div>
          </div>
        </div>
        <!-- Item -->
        <div class="col-xl-4 col-sm-6">
          <div class="item d-flex align-items-center">
            ...
            <div class="title"><span>Totall links<br>Visits</span>
              <div class="progress">
            ...
            <div class="number"><strong>{{$linkVisit}}</strong></div>
          </div>
        </div>
        <!-- Item -->
        <!-- Item -->
        <div class="col-xl-4 col-sm-6">
          <div class="item d-flex align-items-center">
            ...
            <div class="title"><span>My<br>Earning</span>
              <div class="progress">
            ...
            <div class="number"><small>TZS</small><strong> {{$linkVisit * 10 }}</strong></div>
          </div>
        </div>
      </div>
    </div>
